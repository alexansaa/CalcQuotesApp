...
<div align="center">
  ...
  <h3><b>Math Magician Full Website</b></h3>
...
**To-Do List** is a Node.js - React project that is meant to implement a on-line calculator and a API consuming quote page. This project uses modules in its simplest expression.
...
- **Home page, Calculator App and Quote API consuming page included**
- **Personal Style**
